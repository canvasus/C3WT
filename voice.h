...
#define FILTER_MAX_CUTOFF 13500
...
struct Patch
{
  ...
  float cutoff = FILTER_MAX_CUTOFF;
  float resonance = 0.7;
...
class VoiceBank
{
  ...
  public:
    ...
    void setAmpEnv_sustain(uint16_t sustain);
    void setAmpEnv_release(uint16_t release);

    void setFilterEnv_attack(uint16_t attack);
    void setFilterEnv_decay(uint16_t decay);
    void setFilterEnv_sustain(uint16_t sustain);
    void setFilterEnv_release(uint16_t release);

    void setFilterEnv_amplitude(uint16_t amplitude);

    void setEnv3_attack(uint16_t attack);
    void setEnv3_decay(uint16_t decay);
    void setEnv3_sustain(uint16_t sustain);
    void setEnv3_release(uint16_t release);

    void setFilterCutoff(uint16_t cutoff);
    void setFilterResonance(uint16_t resonance);

    void setLfo1Waveform(uint16_t waveform);
    void setLfo2Waveform(uint16_t waveform);

    void setLfo1Level(uint16_t level);
    void setLfo2Level(uint16_t level);

    void setLfo1Frequency(uint16_t frequency);
    void setLfo2Frequency(uint16_t frequency);
...
//void importWaveTable(const unsigned int * waveTableI32);
